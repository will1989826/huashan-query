    ...
    <div class="about-body guide-body">
      <details id="help-usage" class="help-major">
        ...
        <div class="help-major-body">
          ...
          <details id="help-tools" class="help-topic">
            ...
            <div class="help-topic-body"><ol class="help-steps">
              <li>“华山规则”可按分类浏览，也可输入关键词查找分数、评选、身份、版型和违规扣分规则；清空关键词即可恢复当前分类的全部规则。</li>
      ...
      <details id="help-faq" class="help-major faq-section">
        ...
        <div class="faq-group"><h4>华山工具箱</h4><div class="faq-list">
          <details class="faq-item"><summary>华山规则依据哪一版手册？</summary><p>规则速查整理自《华山论剑赛事手册》2026.9.9，每条规则末尾标注对应章节和页码。手册更新后本工具会同步内容，页面标题也会显示当前依据的版本。牌局记录中的出局原因沿用工具既有名称，与手册用词是同一件事，例如“狼美人连人”对应手册的“殉情”，“石像鬼猎杀”对应手册的“带刀”。</p></details>
          <details class="faq-item"><summary>规则速查里为什么没有报名、赛程和奖金内容？</summary><p>规则速查只收录影响牌局判定和单局得分的内容：算分与评选、牌局规则、版型规则、违规与扣分。赛事组织和赛务安排请以官方公告为准。</p></details>
