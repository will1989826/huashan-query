    ...
    <div class="about-body guide-body">
      <details id="help-usage" class="help-major">
        ...
        <div class="help-major-body">
          ...
          <details id="help-compare" class="help-topic">
            ...
            <div class="help-topic-body"><ol class="help-steps">
              <li>可以逐次搜索并点“＋ 对比”，也可以点“批量添加对比”。名单区完整展示 12 格，输入名字后按回车或点录入按钮，名字会变成“已录入”标签，并自动跳到下一格；点标签可修改，点旁边的“×”可移除。</li>
      ...
      <details id="help-faq" class="help-major faq-section">
        ...
        <div class="faq-group"><h4>个人数据</h4><div class="faq-list">
          <details class="faq-item"><summary>批量添加的已录入人数为什么与可新增人数不同？</summary><p>“已录入”表示名字已保存到名单，尚未确认是哪名选手；正在编辑的名字单独显示为待录入，查找时会一并录入。空格不拆分英文名，重复名字只算一次。多名粘贴超过空位时会整段拒绝并提示，不会悄悄截断。查找结果还会排除已在对比篮中或多次选中的同一名选手，因此可新增人数可能更少；最终按实际新增人数校验剩余名额。修改名单后会收起旧结果，避免把上一轮选手加入对比篮。</p></details>
