...
go build -ldflags "-s -w -H windowsgui -X main.version=v%VER%-test -X main.buildMode=test -X main.updateURL=%UPD%" -o "bin\huashan-query-test-v%VER%.exe" . || goto :err
echo.
echo ============================================
echo   Done!  bin\huashan-query-test-v%VER%.exe
