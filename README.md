...
- **赛事数据**：从首页独立进入全页面赛事查询，可按赛区 / 赛季 / 比赛类型查看门派排名；官方排名先显示，参赛轮次按每页 100 条逐页读取，门派成员最多并发读取 8 名选手的逐场战绩。
...
- 踢馆赛和常规赛按每名选手每比赛日三场，将所选赛事的官方轮次折算为“天数”，日均分为官方门派总分除以天数；季后赛、总决赛及其他赛制直接显示实际场次，场均分为官方门派总分除以场次。为避免跨赛区换队导致误算，这些指标只在选择具体赛区并手动查询后逐页加载，所有轮次页完整后才显示最终结果。
