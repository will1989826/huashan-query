...
- **多人对比**（对比篮，最多 12 人）：全景概览、焦点对照和数据详览共用数据与范围，记住视图选择，均适配全部主题；焦点对照可从全员中选择最多 4 人，原有完整表格随时可切回。
  - **批量添加**：12 个名额完整展开，回车录入后显示独立名字标签并跳到下一格，可修改、移除或整段粘贴；实时区分已录入和待录入人数，查找后才展开候选，修改名单会收起旧结果。
  ...
  - 数据详览中，2～4 人使用卡片列，5～12 人使用表格；全体共享赛区 / 赛季范围，可隐藏选手聚焦查看，点选手名进入单人详情。
...
桌面版使用 `v0.9.0` 形式的 Git 标签；小程序发布后使用 `miniprogram-v0.1.0` 形式的标签，避免两个产品的版本标签重名。
